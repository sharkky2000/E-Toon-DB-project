...
<div class="nav-item">
    ...
    <body translate="no" data-gr-c-s-loaded="true">
		<div class="wrapper">
		<?php
				$sql = "SELECT COUNT(cartoon_id) FROM cartoon INNER JOIN typecartoon ON type_id = type WHERE type_cartoon = 'Action'";
				$result = mysqli_query($conn, $sql);
				$row = mysqli_fetch_array($result);
				echo "<h2><strong>Genres of Action<span>( ".$row['COUNT(cartoon_id)']." )</span></strong></h2>";
			?>
			<div class="cards">
				<?php
					$sql = "SELECT * FROM cartoon INNER JOIN typecartoon ON type_id = type WHERE type_cartoon = 'Action'";
					$result = mysqli_query($conn, $sql);
			...
			<div class="news">
				<figure class="article">
					<img src="img\Onepice.jpg" height = "238" width= "350">
					<figcaption>
          <x>
          <h3>Coming Soon</h3>
            One Piece is a Japanese manga series written and illustrated by Eiichiro Oda. It has been serialized in Shueisha's Weekly Shōnen Jump magazine since July 22, 1997, and has been collected into 95 tankōbon volumes.
				...
				<figure class="article">
					<img src="img\Naruto.jpg" height = "238" width= "350">
					<figcaption>
          <x>
						<h3>Coming Soon</h3>
            Naruto is a Japanese manga series written and illustrated by Masashi Kishimoto. It tells the story of Naruto Uzumaki, a young ninja who seeks to gain recognition from his peers and also dreams of becoming the Hokage, the leader of his village.
          </x>
					</figcaption>
				</figure>
				<figure class="article">
					<img src="img\Boruto.jpg" height = "238" width= "350">
					<figcaption>
					<x>	<h3>Coming Soon</h3>
