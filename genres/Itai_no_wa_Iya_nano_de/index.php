            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-md-6">
                    <div class="about_thumb">
                        <img  src="/E-Toon/genres/img/Itai no wa Iya nano de.jpg"  hspace="100" vspace="20" width="270" height="345">
                    </div>
                </div>
                <div class="col-xl-7 col-md-6">
                    <div class="about_info">
                        <h3> Itai no wa Iya nano de Bougyoryoku ni Kyokufuri Shitai to Omoimasu</h3>
                        <br>
                        <p>น้องโล่สายแทงก์ แกร่งเกินร้อยฮอนโจ คาเอเดะ (เมเปิ้ลชื่อในเกม)เป็นสาวน่ารักๆ ที่ถูกเพื่อนแสนเก่งและน่ารักชื่อ ชิโรมิเนะ ริสะ (ซารี่ในเกม)ชวนมาเล่นเกมในโลกเสมือนจริง VRMMORPG
แต่คาเอเดะดันเป็นพวกมือใหม่ ที่ไม่อยากเจ็บตัวหรือบาดเจ็บ จึงอยากเน้นเรื่องการป้องกันเป็นพิเศษ โดยเน้นค่า VIT และไม่อัพค่าอื่นใดๆ ทำให้ศัตรูทำ Damage ไม่เข้าสักกระนิดพร้อมมีสกิลการป้องกันสมบูรณ์แบบคาเอเดะหรือสาวเมเปิ้ลจึงได้ออกผจญภัย
และเข้าร่วมอีเว้นท์ครั้งแรกของเกมทำให้ตนเองถูกหากว่าเป็นปราการบอสอันแกร่งแข็งจนมีชื่อเสียงร่ำลือไกลด้วยความเป็นมือใหม่แต่ได้ความเทพมาไว้ครอบครองและสร้างความปวดหัวประหลาดๆให้GM เป็นว่าเล่น</p>
                    </br>
                    </div>
                </div>
            </div>
...
<!-- เพิ่มตอน --->
<?php
$sql = "SELECT * FROM episode INNER JOIN cartoon ON id_cartoon = cartoon_id WHERE id_cartoon = 15";
