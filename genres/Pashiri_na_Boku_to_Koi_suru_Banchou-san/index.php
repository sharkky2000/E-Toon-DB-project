            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-md-6">
                    <div class="about_thumb">
                        <img  src="/E-Toon/genres/img/Pashiri na Boku to Koi suru Banchou-san.jpg"  hspace="100" vspace="20" width="270" height="345">
                    </div>
                </div>
                <div class="col-xl-7 col-md-6">
                    <div class="about_info">
                        <h3>Pashiri na Boku to Koi suru Banchou-san</h3>
                        <br>
                        <p>เรื่องย่อ : อูโนกิคุง เด็กหนุ่มผู้ถูกรังแกมาตั้งแต่เด็กยันโต ต้องกลายเป็นข้ารับใช้ให้กับโทระมารุซัง เด็กสาวอันธพาลผู้มีชื่อเสียง เขาเข้าใจผิดว่าอีกฝ่ายต้องการข่มเหงรังแกตัวเอง ทว่าความจริงแล้วเธอก็แค่หลงรักเขาเท่านั้นเอง... </p>
                    </br>
                    </div>
                </div>
            </div>
...
<!-- เพิ่มตอน --->
<?php
$sql = "SELECT * FROM episode INNER JOIN cartoon ON id_cartoon = cartoon_id WHERE id_cartoon = 9";
