            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-md-6">
                    <div class="about_thumb">
                        <img  src="img/cartoon/Subasa.jpg"  hspace="100" vspace="20" width="270" height="345">
                    </div>
                </div>
                <div class="col-xl-7 col-md-6">
                    <div class="about_info">
                        <h3>กัปตัน ซึบาสะ</h3>
                        <br>
                        <p>เรื่องย่อ : เรื่องราวจะเล่าถึงเด็กน้อยที่ชื่อ “โอโซระ ซึบาสะ”(โอโซระ – ท้องฟ้าอันกว่างไกล / สึบาสะ – ปีก รวมกันจะได้ความหทายว่า “ปีกที่บินไปบนท้องฟ้าอันกว้างไกล”)
                          เด้กน้อยจากเมืองนันคัตซึ จังหวัดชิสึโอกะ ประเทศญี่ปุ่น ที่ผูกพันกับฟุตบอลตั้งแต่กำเนิด จากการที่รอดตายจากเหตุรถชน เพราะลูกฟุตบอลรับแรงกระแทกไว้ ซึบาสะจึงนับว่า
                          “ฟุตบอลคือเพื่อนรัก” ของเขานับแต่นั้น</p>
                    </br>
                    </div>
                </div>
            </div>
...
<!-- เพิ่มตอน --->
<?php
$sql = "SELECT * FROM episode INNER JOIN cartoon ON id_cartoon = cartoon_id WHERE id_cartoon = 5";
