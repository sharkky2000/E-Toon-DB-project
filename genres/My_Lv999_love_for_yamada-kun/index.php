            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-md-6">
                    <div class="about_thumb">
                        <img  src="/E-Toon/genres/img/My Lv999 love for yamada-kun.jpg"  hspace="100" vspace="20" width="270" height="345">
                    </div>
                </div>
                <div class="col-xl-7 col-md-6">
                    <div class="about_info">
                        <h3>My Lv999 Love for Yamada-kun</h3>
                        <br>
                        <p> เรื่องย่อ : Her boyfriend was stolen through an online game! During this heartbreak, she logged in to the game and met...!?</p>
                    </br>
                    </div>
                </div>
            </div>
...
<!-- เพิ่มตอน --->
<?php
$sql = "SELECT * FROM episode INNER JOIN cartoon ON id_cartoon = cartoon_id WHERE id_cartoon = 7";
