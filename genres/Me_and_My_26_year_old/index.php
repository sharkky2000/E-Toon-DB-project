            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-md-6">
                    <div class="about_thumb">
                        <img  src="/E-Toon/genres/img/Me and My 26 year old.jpg"  hspace="100" vspace="20" width="270" height="345">
                    </div>
                </div>
                <div class="col-xl-7 col-md-6">
                    <div class="about_info">
                        <h3>Me and My 26-year-old Female Tenant</h3>
                        <br>
                        <p>เรื่องย่อ : is name is Qin Ruo, and he is a very dangerous person, with handsome but somewhat nasty gaze, he gives rather complicated impressions to others. Owing a third-story villa with a huge swimming pool, he is literally a rich guy but what he only lacks is a hot female companion! "Can I stay here?" she knocked open his door. He ogled her curved body with his eyes almost popping out and welcomed her in... </p>
                       </br>
                    </div>
                </div>
            </div>
...
<!-- เพิ่มตอน --->
<?php
$sql = "SELECT * FROM episode INNER JOIN cartoon ON id_cartoon = cartoon_id WHERE id_cartoon = 2";
