            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-md-6">
                    <div class="about_thumb">
                        <img  src="img/cartoon/sololevel.jpg"  hspace="100" vspace="20" width="270" height="345">
                    </div>
                </div>
                <div class="col-xl-7 col-md-6">
                    <div class="about_info">
                        ...
                        <h3>Solo leveling</h3>
                        <br>
                        <p>เรื่องย่อ : เป็นเรื่องราวของชายหนุ่มที่มีความฝันอยากจะเอาฮันเตอร์ เพื่อนที่จะได้เอาเงินมารักษาแม่ให้หายจากโรคที่ไม่มีวันตื่น แต่เขากลับเป็นฮันเตอร์ ที่อ่อนที่มีแรงค์ที่ต่ำที่สุดแต่แล้วเขาก็ได้รักโอกาสจากดันที่เขาต้องเข้าไปตีบอสแล้วได้พลังพิเศษมา
            เขาจะรอดจากดันนี้หรือไม่ และจะช่วยแม่ของเขาได้หรือเปล่า เรามาติดตามชมกันเลยครับ</p>
                    </br>
                    </div>
                </div>
            </div>
...
<!-- เพิ่มตอน --->
<?php
          $sql = "SELECT * FROM episode INNER JOIN cartoon ON id_cartoon = cartoon_id WHERE id_cartoon = 1";
