            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-md-6">
                    <div class="about_thumb">
                        <img  src="/E-Toon/genres/img/Haikyu.jpg"  hspace="100" vspace="20" width="270" height="345">
                    </div>
                </div>
                <div class="col-xl-7 col-md-6">
                    <div class="about_info">
                        <h3>Haikyuu!!</h3>
                        <br>
                        <p>เรื่องย่อ : ฮินาตะ โชวโยว "เขาคือสมอล์ใจแอนท์อย่างแน่นอนครับ"นั้นคือคำพูดของผู้บรรยายทางโทรทัศน์ที่ฮินาตะ โชวโยวได้ยินมันเป็นการแข่งวอลเลย์บอลที่ดุเดือดและคำพูดนั้นก็ทำให้เขาเลือกที่จะเล่นวอลเลย์บอล และวันนั้นก็มาถึงการแข่งวอลเลย์บอลระดับม.ต้นแต่ทว่าต้องเจอกับทีมคู่แข่งที่เป็นเต็งแล้วเขาจะเอาชนะได้หรือไม่ เรื่องราวจะดำเดินไปยังไง โปรดติดตามชมได้เลย</p>
                    </br>
                    </div>
                </div>
            </div>
...
<!-- เพิ่มตอน --->
<?php
$sql = "SELECT * FROM episode INNER JOIN cartoon ON id_cartoon = cartoon_id WHERE id_cartoon = 3";
