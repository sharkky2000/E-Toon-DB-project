...
@media screen and (max-width: 600px) {
  .column.side, .column.middle {
    ...
    <body translate="no" data-gr-c-s-loaded="true">
		<div class="wrapper">
		<?php
				$sql = "SELECT COUNT(cartoon_id) FROM cartoon INNER JOIN typecartoon ON type_id = type WHERE type_cartoon = 'Fantasy'";
				$result = mysqli_query($conn, $sql);
				$row = mysqli_fetch_array($result);
				echo "<h2><strong>Genres of Fantasy<span>( ".$row['COUNT(cartoon_id)']." )</span></strong></h2>";
			?>
			<div class="cards">
				<?php
					$sql = "SELECT * FROM cartoon INNER JOIN typecartoon ON type_id = type WHERE type_cartoon = 'Fantasy'";
					$result = mysqli_query($conn, $sql);
			...
			<div class="news">
				<figure class="article">
					<img src="img\Yakitate.jpg" height = "238" width= "350">
					<figcaption>
            <x>
              <h3>Coming Soon</h3>
              Yakitate!! Japan is a Japanese manga series written and illustrated by Takashi Hashiguchi. It was serialized in Shogakukan's Weekly Shōnen Sunday from January 2002 to January 2007. The manga has spanned 26 tankōbon volumes.
				...
				<figure class="article">
					<img src="img\Shokugeki no Soma.png" height = "238" width= "350">
					<figcaption>
          <x>
						<h3>Coming Soon</h3>
            Hinomaru Sumo is Japanese sumo shōnen manga series written and illustrated by Kawada. It was published by Shueisha, with serialization in Weekly Shōnen Jump magazine since May 2014 and with twenty-eight volumes compiling the chapters released until its end in July 2019 after 5 years of serialization.
				...
				<figure class="article">
					<img src="img\Conan.jpg" height = "238" width= "350">
					<figcaption>
					<x>	<h3>Coming Soon</h3>
            Case Closed, also known as Detective Conan, is a Japanese detective manga series written and illustrated by Gosho Aoyama. It has been serialized in Shogakukan's Weekly Shōnen Sunday since January 19, 1994, and has been collected into 97 tankōbon volumes as of December 18, 2019.
          </x>
					</figcaption>
				</figure>
			</div>
