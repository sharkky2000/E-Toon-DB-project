...
@media screen and (max-width: 600px) {
  .column.side, .column.middle {
    ...
    <body translate="no" data-gr-c-s-loaded="true">
		<div class="wrapper">
		<?php
				$sql = "SELECT COUNT(cartoon_id) FROM cartoon INNER JOIN typecartoon ON type_id = type WHERE type_cartoon = 'Adult'";
				$result = mysqli_query($conn, $sql);
				$row = mysqli_fetch_array($result);
				echo "<h2><strong>Genres of Adult<span>( ".$row['COUNT(cartoon_id)']." )</span></strong></h2>";
			?>
			<div class="cards">
				<?php
					$sql = "SELECT * FROM cartoon INNER JOIN typecartoon ON type_id = type WHERE type_cartoon = 'Adult'";
					$result = mysqli_query($conn, $sql);
			...
			<div class="news">
				<figure class="article">
					<img src="img\Blue Exorcist.png" height = "238" width= "350">
					<a href = "#"><figcaption>
          <x>
            <h3>Update new</h3>
            Blue Exorcist is a Japanese manga series written and illustrated by Kazue Katō. The manga has been serialized in Jump Square magazine by Shueisha since April 2009, with individual chapters collected into twenty-two tankōbon volumes as of November 2, 2018.
        </x>
					</figcaption></a>
				</figure>
				<figure class="article">
					<img src="img\Kimetsu no Yaiba.jpg" height = "238" width= "350">
					<figcaption>
          <x>
						<h3>Coming Soon</h3>
            Kimetsu no Yaiba is a Japanese manga series written and illustrated by Koyoharu Gotōge. The story follows Tanjiro Kamado, a young boy who becomes a demon slayer after his family is slaughtered and his younger sister Nezuko is turned into a demon.
          </x>
					</figcaption>
				</figure>
				<figure class="article">
					<img src="img\Hinomaru Sumo.jpg" height = "238" width= "350">
					<figcaption>
					<x>
            <h3>Coming Soon</h3>
            Hinomaru Sumo is Japanese sumo shōnen manga series written and illustrated by Kawada. It was published by Shueisha, with serialization in Weekly Shōnen Jump magazine since May 2014 and with twenty-eight volumes compiling the chapters released until its end in July 2019 after 5 years of serialization.
          </x>
					</figcaption>
				</figure>
			</div>
