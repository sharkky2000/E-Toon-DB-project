...
@media screen and (max-width: 600px) {
  .column.side, .column.middle {
    ...
    <body translate="no" data-gr-c-s-loaded="true">
		<div class="wrapper">
		<?php
				$sql = "SELECT COUNT(cartoon_id) FROM cartoon INNER JOIN typecartoon ON type_id = type WHERE type_cartoon = 'Sport'";
				$result = mysqli_query($conn, $sql);
				$row = mysqli_fetch_array($result);
				echo "<h2><strong>Genres of Sport<span>( ".$row['COUNT(cartoon_id)']." )</span></strong></h2>";
			?>
			<div class="cards">
				<?php
					$sql = "SELECT * FROM cartoon INNER JOIN typecartoon ON type_id = type WHERE type_cartoon = 'Sport'";
					$result = mysqli_query($conn, $sql);
			...
			<div class="news">
				<figure class="article">
					<img src="img\The Prince of Tennis.jpg" height = "238" width= "350">
					<figcaption>
          <x>
          <h3>Coming Soon</h3>
            The Prince of Tennis is a Japanese manga series written and illustrated by Takeshi Konomi. The manga was serialized in Shueisha's Weekly Shōnen Jump from July 1999 to March 2008. A total of 379 chapters were published and collected into 42 tankōbon volumes.
				...
				<figure class="article">
					<img src="img\Ace of Diamond.jpg" height = "238" width= "350">
					<figcaption>
          <x>
						<h3>Coming Soon</h3>
            Ace of Diamond is a Japanese shōnen baseball manga series written and illustrated by Yuji Terajima and published by Kodansha. It has been serialized by Weekly Shōnen Magazine from 2006 to 2015. A sequel titled Ace of Diamond Act II started in 2015. An anime adaptation ran from 6 October 2013 to 28 March 2016.
          </x>
					</figcaption>
				</figure>
				<figure class="article">
					<img src="img\Slam Dunk.jpg" height = "238" width= "350">
					<figcaption>
					<x>	<h3>Coming Soon</h3>
