  ...
  .column.side, .column.middle {
   ...
   <header class="header-section">
    ...
    <body translate="no" data-gr-c-s-loaded="true">
		<div class="wrapper">
		<?php
				$sql = "SELECT COUNT(cartoon_id) FROM cartoon INNER JOIN typecartoon ON type_id = type WHERE type_cartoon = 'School'";
				$result = mysqli_query($conn, $sql);
				$row = mysqli_fetch_array($result);
				echo "<h2><strong>Genres of School<span>( ".$row['COUNT(cartoon_id)']." )</span></strong></h2>";
			?>
			<div class="cards">
				<?php
					$sql = "SELECT * FROM cartoon INNER JOIN typecartoon ON type_id = type WHERE type_cartoon = 'School'";
					$result = mysqli_query($conn, $sql);
			...
			<div class="news">
				<figure class="article">
					<img src="img\JoJo's Bizarre.jpg" height = "238" width= "350">
					<figcaption>
          <x>
          <h3>Coming Soon</h3>
				...
				<figure class="article">
					<img src="img\Fist of the North Star.jpg" height = "238" width= "350">
					<figcaption>
          <x>
						<h3>Coming Soon</h3>
            Fist of the North Star is a Japanese manga series written by Buronson and illustrated by Tetsuo Hara. Serialized in Weekly Shōnen Jump from 1983 to 1988, the 245 chapters were initially collected in 27 tankōbon volumes by Shueisha.
				...
				<figure class="article">
					<img src="img\Dragon Ball.jpg" height = "238" width= "350">
					<figcaption>
					<x>	<h3>Coming Soon</h3>
