            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-md-6">
                    <div class="about_thumb">
                        <img  src="/E-Toon/genres/img/Why the Hell are You Here Teacher.jpg"  hspace="100" vspace="20" width="270" height="345">
                    </div>
                </div>
                <div class="col-xl-7 col-md-6">
                    <div class="about_info">
                        <h3>Why the Hell are You Here Teacher (18+)</h3>
                        <br>
                        <p>เรื่องย่อ :Ichirou Satou วัย 17 ปีเป็นวัยรุ่นที่มักจะเกิดขึ้นกับตัวเองในสถานการณ์ที่ผิดกับครู Kana Kojima ของเขา ติดตามเรื่องตลกเกี่ยวกับกามที่เกี่ยวกับความผิดพลาดของพวกเขาตลอดชีวิตประจำวันของพวกเขาและวิธีการที่ Ichirou และ Kana เลือกที่จะจัดการกับพวกเขา Nande Koko Ni Sensei Ga หรือทำไมคุณถึงนี่ Sensei เป็นมังงะ ecchi แบบฉบับของคุณคุณสามารถจบน้อยกว่าหนึ่งชั่วโมง เช่นเดียวกับการ์ตูน ecchi อื่น ๆ Nande Koko ni Sensei Ga มีฉาก ecchi แบบคลาสสิกเช่น MC ชายที่ตกจากหน้าอกของหญิงและภาพ pantie แล้วมันก็เป็นอีกมังงะแบบโฮมเมดที่น่าเบื่อหน่อย? ไม่เป็นการ์ตูนตลกและสบาย ๆ นี่คือสิ่งที่ฉันชอบเกี่ยวกับมังงะนี้:มันสั้นและเรื่องไม่ได้ล้าหลังเลย;มันมีฉาก ecchi cliche แต่มันก็ถูกประหารชีวิตในทางตลกเนื่องจากมังงะนี้ไม่ใช่ฮาเร็มชายหนุ่มคนนี้จึงไม่ต้องเสียเวลาบทใดในการตัดสินใจเลือกสาวมันมีศิลปะที่ดีมี 'แสง' ตลกที่ดีนี่คือสิ่งที่ฉันไม่ชอบเกี่ยวกับมังงะนี้:มันสั้นเกินไปมังงะนี้เป็นมังงะที่แฟน ๆ ของ ecchi จะชอบ มังงะแบบสบาย ๆ พร้อมภาพศิลปะและบริการที่ยอดเยี่ยม สั้นและสนุกสนาน</p>
                    </br>
                    </div>
                </div>
            </div>
...
<!-- เพิ่มตอน --->
						<?php
$sql = "SELECT * FROM episode INNER JOIN cartoon ON id_cartoon = cartoon_id WHERE id_cartoon = 13";
