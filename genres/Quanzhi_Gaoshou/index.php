            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-md-6">
                    <div class="about_thumb">
                        <img  src="/E-Toon/genres/img/Quanzhi Gaoshou.jpg"  hspace="100" vspace="20" width="270" height="345">
                    </div>
                </div>
                <div class="col-xl-7 col-md-6">
                    <div class="about_info">
                        <h3> Quanzhi Gaoshou (The king's avatar) </h3>
                        <br>
                        <p> เรื่องย่อ : ในเกมส์ Glory มีผู้เล่นหลายคนที่มีระดับถึง Pro player ด้วยเกมส์ที่เป็น Esport ใหญ่โตมากมาย ก็ได้มีผู้เล่นชั้นแนวหน้าอย่าง เยี่ยซิว ที่พึ่งโดนเขี่ยออกจากสโมสรที่เขาอยู่มาเกือบ 10 ปี เขาก็เลยออกมาทำงาน ที่อินเตอร์เน็ตค่าเฟ่ในฐานะ ผู้จัดการร้านในกะดึกและในขณะนั้นเอง เซิร์ฟเวอร์ที่ 10 ของ Glory ก็ได้เปิดตัวขึ้น เยี่ยซิวก็เลย คืนสู่วงการ ด้วยการเล่นใหม่เริ่มต้นใหม่อีกครั้งกับเซิร์ฟเวอร์ 10</p>
                    </br>
                    </div>
                </div>
            </div>
...
<!-- เพิ่มตอน --->
<?php
$sql = "SELECT * FROM episode INNER JOIN cartoon ON id_cartoon = cartoon_id WHERE id_cartoon = 10";
